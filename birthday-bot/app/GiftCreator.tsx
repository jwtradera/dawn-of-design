  ...
  const addGift = async () => {
    ...
    */
    const payload: Types.TransactionPayload = {
      ...
      function: `${process.env.MODULE_ADDRESS}::${process.env.MODULE_NAME}::add_birthday_gift`, // The address::module::function to call
      type_arguments: [],
      arguments: [
        address, // recipient address
        Math.floor(parsedAmount * Math.pow(10, 8)), // Gift amount
        Math.floor(date.getTime() / 1000), // birthday seconds
      ],
    };
